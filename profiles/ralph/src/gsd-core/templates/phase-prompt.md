...
<!-- For checkpoint task examples and patterns, see @/home/floyddan/.config/opencode/gsd-core/references/checkpoints.md -->
...
See `/home/floyddan/.config/opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/floyddan/.config/opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/floyddan/.config/opencode/gsd-core/workflows/verify-phase.md` for verification logic.
