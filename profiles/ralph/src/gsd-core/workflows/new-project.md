...
Use template: /home/floyddan/.config/opencode/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /home/floyddan/.config/opencode/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /home/floyddan/.config/opencode/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /home/floyddan/.config/opencode/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /home/floyddan/.config/opencode/gsd-core/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.claude/AGENTS.md` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, `.claude/AGENTS.md` otherwise; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
