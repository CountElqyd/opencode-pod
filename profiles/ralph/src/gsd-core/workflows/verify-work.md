...
<template>
@/home/floyddan/.config/opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/floyddan/.config/opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/floyddan/.config/opencode/gsd-core/workflows/transition.md`.
...
- Follow @/home/floyddan/.config/opencode/gsd-core/workflows/diagnose-issues.md
