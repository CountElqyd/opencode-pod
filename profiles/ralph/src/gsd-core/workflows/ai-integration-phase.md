...
<required_reading>
@/home/floyddan/.config/opencode/gsd-core/references/ai-frameworks.md
@/home/floyddan/.config/opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/floyddan/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/floyddan/.config/opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/floyddan/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/floyddan/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/floyddan/.config/opencode/agents/gsd-eval-planner.md for instructions.
