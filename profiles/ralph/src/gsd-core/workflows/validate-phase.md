...
```
Agent(
  prompt="Read /home/floyddan/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/floyddan/.config/opencode/gsd-core/templates/VALIDATION.md`
