...
**question tool Q1 — include ALL of these:**
...
**question tool Q2 — present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused question tool. After the user decides, re-check coherence with the rest of the system.
...
**question tool Q-final — show summary and confirm:**
