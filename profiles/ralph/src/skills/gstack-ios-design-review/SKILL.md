...
4. Use question tool for any score < 7 — present the issue with
...
| Screenshot is black/blank | App may be in foreground but not rendering; the question tool to confirm the app is in the expected state |
| 10 screens, but ground-truth screen list said 12 | Use question tool: were 2 hidden behind state we haven't triggered? |
