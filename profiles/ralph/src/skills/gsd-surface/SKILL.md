...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/floyddan/.config/opencode/.gsd-surface.json`
(sibling to `/home/floyddan/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/floyddan/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/floyddan/.config/opencode/skills`).
...
`/home/floyddan/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/floyddan/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/floyddan/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/floyddan/.config/opencode/.gsd-profile`
Skill dirs: `/home/floyddan/.config/opencode/skills/gsd-*/`
Engine module: `/home/floyddan/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/floyddan/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
