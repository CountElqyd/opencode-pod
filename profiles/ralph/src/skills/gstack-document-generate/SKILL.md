...
2. Use the question tool to confirm scope and ask about documentation target:
...
If the plan has more than 5 documents to create, use the question tool to confirm before proceeding.
