...
**question tool with pre-filled context:** Pre-fill what you inferred from the codebase,
...
Use the question tool to confirm before spending API credits:
...
After receiving feedback (via HTTP POST or question tool fallback), output a clear
...
Use the question tool to confirm before saving.
...
If standalone, offer next steps via the question tool:
