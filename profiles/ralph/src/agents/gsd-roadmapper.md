...
Reference full template: `/home/floyddan/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/floyddan/.config/opencode/gsd-core/templates/state.md`.
